const stagesData = [
    { id:1, name:"پناه آخر", location:"کافه آخرین پناه", time:"03:42", difficulty:"متوسط",
      ...
      question:"رمز عبور قفسه امانات چیست؟", options:["سایه","نگاه","باد","ماه","آینه"], correct:1,
      clue:"چشم‌هایی که می‌بینند اما دیده نمی‌شوند - نام مظنون: سایه‌نورد",
    ...
    { id:2, name:"تئاتر سکوت", location:"تئاتر متروک زوال", time:"01:15", difficulty:"متوسط",
      narrative:"تئاتر بوی کپک و شراب کهنه می‌دهد. دو سنگ قبر در ورودی: دروغ و سکوت. صدایی می‌گوید: تنها یکی از اینها تو را عبور می‌دهد. سنگی که حقیقت را پنهان می‌کند.",
      question:"روی کدام سنگ باید قدم بگذاری؟", options:["سنگ دروغ","سنگ سکوت","دور زدن سنگ‌ها","گفتن رمز به در","زدن لگد به در"], correct:1,
      clue:"سکوت حقیقت را فریاد می‌زند - آدرس: اسکله شرقی، انبار 7",
    ...
    { id:3, name:"سه نت مرگ", location:"سالن اصلی تئاتر", time:"02:20", difficulty:"سخت",
      narrative:"پیانوی قدیمی روی صحنه. برگه: سه نت از قلب شب بنواز: جایی که نور نمی‌تابد، جایی که آب جاری نیست، جایی که سکوت فریاد می‌زند.",
      question:"ترتیب درست سه شیء برای نواختن نت‌ها چیست؟", options:["شمع، آینه، کاسه","آینه، کاسه، شمع","کاسه، شمع، آینه","شمع، کاسه، آینه","آینه، شمع، کاسه"], correct:3,
      clue:"شمع در تاریکی، کاسه خالی بدون آب، آینه شکسته در سکوت - نوار صوتی حقیقت زوال",
    ...
    { id:4, name:"صندوق امانات", location:"بانک مرکزی زوال", time:"04:00", difficulty:"سخت",
      narrative:"نوار صوتی قطع می‌شود. روی دیوار: اولین روز هفته در شهر آبی (شنبه = 1)، ساعت 23 (11 شب)، پل دوم (2)، پایین‌ترین عدد آسمان (0).",
      question:"رمز چهار رقمی صندوق امانات چیست؟", options:["0112","2311","1230","1234","4213"], correct:0,
      clue:"0112 - پرونده پروژه زوال و کلید مسی مارپیچ",
    ...
    { id:5, name:"رد آخر", location:"برج ساعت مرکزی", time:"05:30", difficulty:"نهایی",
      narrative:"زیرزمین برج. روی در حک شده: آغاز و پایان یک سفر. شهر زوال یعنی پایان، افول. مقابل آن چیست؟",
      question:"کلمه رمز ورود به زیرزمین چیست؟", options:["طلوع","آغاز","انحلال","سقوط","رستاخیز"], correct:0,
      clue:"طلوع مقابل زوال - حقیقت فاش شد: قتل‌ها دستور از دفتر فرمانداری",
    ...
    { id:6, name:"کوچه بن‌بست", location:"کوچه پشت تئاتر", time:"00:30", difficulty:"آسان",
      narrative:"در بن‌بست کوچه، روی دیوار با گچ نوشته شده: شماره 7 را به خاطر بسپار.",
      question:"چه عددی کلید بعدی است؟", options:["3","5","7","9","11"], correct:2,
      clue:"7 - انبار شماره 7 در اسکله شرقی", evidence:"ته سیگار خارجی", suspect:"فرد سیگاری با کلاه", reward:10, focusPenalty:5 },
    { id:7, name:"اسکله شرقی", location:"اسکله شرقی", time:"01:45", difficulty:"متوسط",
      ...
      clue:"ماه هر شب می‌آید اما نمی‌ماند - کلید زیر آجر سوم", evidence:"جعبه چوبی خالی", suspect:"ملوان مرموز", reward:15, focusPenalty:5 },
    { id:8, name:"سردخانه", location:"سردخانه متروک", time:"02:10", difficulty:"سخت",
      narrative:"داخل سردخانه، سه قلاب گوشت آویزان است. روی یکی شماره 1، دومی 2، سومی 3. یادداشتی: زنده‌ترین عدد را انتخاب کن. بین 1 و 2 و 3، عدد 3 زنده‌ترین است چون سه‌بعدی و کامل.",
      question:"کدام قلاب را بکشی؟", options:["قلاب 1","قلاب 2","قلاب 3","همه با هم","هیچکدام"], correct:2,
      clue:"3 - کلید در پشتی", evidence:"لکه خون روی قلاب", suspect:"قصاب سابق", reward:20, focusPenalty:10 },
    { id:9, name:"دفتر فرمانداری", location:"دفتر فرمانداری", time:"03:00", difficulty:"سخت",
      narrative:"میز فرماندار به هم ریخته. داخل کشوی مخفی، دفترچه‌ای با رمز سه حرفی. اشاره: حرف اول اسم شهر (ز=زوال) و حرف آخر اسم خیابان اصلی (خیابان نور، حرف آخر ر).",
      question:"رمز سه حرفی چیست؟", options:["زر","زال","زور","دور","راز"], correct:0,
      clue:"زر - کد دسترسی به پرونده اصلی", evidence:"دفترچه یادداشت", suspect:"منشی فرماندار", reward:20, focusPenalty:10 },
    { id:10, name:"بایگانی مخفی", location:"زیرزمین کتابخانه", time:"04:15", difficulty:"نهایی",
      narrative:"قفسه‌های گرد و غبار گرفته. پرونده قرمز رنگ را پیدا می‌کنی. روی آن نوشته: برای باز کردن، بگو نام قاتل. قاتل کسی است که شهر را به زوال کشاند.",
      question:"نام قاتل پرونده چیست؟", options:["سایه‌نورد","سکوت","زوال","رستاخیز","طلوع"], correct:2,
      clue:"زوال قاتل است - همه چیز در این شهر فاسد شده", evidence:"اعتراف کتبی", suspect:"شهردار و فرماندار هر دو", reward:25, focusPenalty:15 },
    { id:11, name:"ایستگاه قطار", location:"ایستگاه مرکزی", time:"00:15", difficulty:"آسان",
      narrative:"بلیط قدیمی روی زمین. شماره سکو محو شده. بلیط: سکوی 2، اما اشاره شده دو برابر 2.",
      question:"سکو چند است؟", options:["2","4","6","8","10"], correct:1,
      clue:"4 - قطار نیمه شب", evidence:"بلیط پاره", suspect:"رفیق سابق", reward:10, focusPenalty:5 },
    { id:12, name:"پل شکسته", location:"پل قدیمی زوال", time:"01:30", difficulty:"متوسط",
      narrative:"زیر پل، جعبه فلزی. روی آن: اولین عدد اول (2)، دومین عدد اول (3)، سومین عدد اول (5) را وارد کن.",
    ...
    { id:13, name:"کلوپ شبانه", location:"کلوپ سایه", time:"02:45", difficulty:"متوسط",
      narrative:"داخل کلوپ، جای وی‌آی‌پی. روی میز کارت دعوت با رمز: عدد بین 7 و 9.",
    ...
    { id:14, name:"اتاق بازجویی", location:"کلانتری قدیمی", time:"03:30", difficulty:"سخت",
      narrative:"روی میز پرونده قتل. سه مظنون: الف، ب، ج. یادداشت: الف می‌گوید ب قاتل است، ب می‌گوید ج قاتل است، ج می‌گوید من بی‌گناهم. فقط یک نفر راست می‌گوید.",
      question:"قاتل کیست؟", options:["الف","ب","ج","الف و ب","ب و ج"], correct:0,
      clue:"الف قاتل است - اعتراف ضبط شده", evidence:"نوار بازجویی", suspect:"ب - معاون سابق", reward:20, focusPenalty:10 },
    { id:15, name:"آرامستان", location:"آرامستان شرقی", time:"00:00", difficulty:"سخت",
      narrative:"قبر بی‌نام. روی سنگ: تولد 1350، مرگ 1400. سن در زمان مرگ 50 سال است (1400-1350).",
    ...
    { id:16, name:"کارخانه متروکه", location:"کارخانه نساجی", time:"01:00", difficulty:"متوسط",
      narrative:"داخل کارخانه، سه ردیف دستگاه. ردیف اول 5، دومی 3، سومی 7. مجموع همه 15.",
      question:"چند ماشین؟", options:["12","13","14","15","16"], correct:3,
      clue:"15 - کمد شماره 15", evidence:"دفترچه حقوق", suspect:"کارگر اخراجی", reward:15, focusPenalty:5 },
    { id:17, name:"برج ناقوس", location:"برج کلیسا", time:"02:30", difficulty:"متوسط",
      narrative:"ناقوس ابتدا 7 بار، سپس 3 بار، سپس 5 بار نواخته شد. مجموع 15.",
      question:"تعداد کل نواخته‌ها؟", options:["10","12","13","15","17"], correct:3,
    ...
    { id:18, name:"حمام عمومی", location:"حمام قدیمی", time:"23:45", difficulty:"آسان",
      narrative:"کاشی‌ها به ترتیب 4، 8، 12، 16. هر مرحله 4 تا اضافه می‌شود. بعدی 20.",
      question:"عدد بعدی روی کاشی؟", options:["18","20","22","24","26"], correct:1,
    ...
    { id:19, name:"سرداب", location:"سرداب کلیسا", time:"04:00", difficulty:"سخت",
      narrative:"تابوت‌ها به ترتیب 1920، 1930، 1940، 1950. هر ده سال یکبار، بعدی 1960.",
      question:"سال روی تابوت بعدی؟", options:["1960","1970","1980","1990","2000"], correct:0,
    ...
    { id:20, name:"مخفیگاه", location:"زیرزمین خانه فرماندار", time:"05:00", difficulty:"نهایی",
      narrative:"صندوق آهنی. رمز: روز تولد فرماندار (1350/12/5). روز 5، ماه 12، به صورت چهاررقمی 0512.",
      question:"رمز چهار رقمی (روز و ماه)؟", options:["512","512","0512","1205","5120"], correct:2,
    ...
    { id:21, name:"بیمارستان", location:"بیمارستان متروکه", time:"01:20", difficulty:"متوسط",
      narrative:"پرونده پزشکی بیمار X. سن او دو برابر نصف 20 (نصف 20 = 10، دو برابر = 20) به اضافه 5 می‌شود 25.",
      question:"سن بیمار؟", options:["20","25","30","35","40"], correct:1,
    ...
    { id:22, name:"داروخانه", location:"داروخانه شبانه‌روزی", time:"02:00", difficulty:"آسان",
      narrative:"قفسه داروها: آمپول آبی 3، قرمز 5، سفید 2. مجموع 10.",
      question:"چند آمپول؟", options:["8","9","10","11","12"], correct:2,
    ...
    { id:23, name:"مدرسه قدیمی", location:"مدرسه زوال", time:"03:15", difficulty:"متوسط",
      narrative:"تخته سیاه: 2+2=5، 3+3=7، 4+4=9. الگو: جواب همیشه یک بیشتر از جمع عادی است. 5+5=10+1=11.",
      question:"5 + 5 = ?", options:["10","11","12","13","14"], correct:1,
    ...
    { id:24, name:"دادگاه", location:"ساختمان دادگستری", time:"12:30", difficulty:"سخت",
      narrative:"سه شاهد: A می‌گوید B قاتل است، B می‌گوید C قاتل است، C می‌گوید بی‌گناهم. فقط یک نفر راست می‌گوید. اگر C بی‌گناه باشد، هر دو A و B دروغ می‌گویند پس A دروغ می‌گوید یعنی B قاتل نیست، B دروغ می‌گوید یعنی C قاتل نیست، پس قاتل A است.",
      question:"قاتل کیست؟", options:["A","B","C","A و B","B و C"], correct:0,
    ...
    { id:25, name:"بندر", location:"بندر قدیمی", time:"04:45", difficulty:"نهایی",
      narrative:"جعبه ضدآب. رمز: تعداد حروف اسم شهر (زوال = 3 حرف) ضرب در 5 = 15، منهای 3 = 12؟ اشتباه، 3 حرف در 5 = 15، منهای 3 = 12 نیست. بیایید اصلاح کنیم: زوال = 4 حرف. 4*5=20-3=17.",
      question:"رمز چند است؟ (توجه: زوال ۴ حرف دارد)", options:["15","16","17","18","19"], correct:2,
      clue:"17 - جعبه باز شد", evidence:"مدارک قاچاق", suspect:"ملوان", reward:25, focusPenalty:15 },
    { id:26, name:"رستوران", location:"رستوران شبانه", time:"23:30", difficulty:"آسان",
      narrative:"صورتحساب: قهوه 5، کیک 7، چای 4، شیرینی 3. بیشترین قیمت 7 مربوط به کیک است.",
      question:"بیشترین قیمت؟", options:["5","6","7","8","9"], correct:2,
      clue:"7 - زیر بشقاب", evidence:"دستمال خونی", suspect:"پیشخدمت", reward:10, focusPenalty:5 },
    { id:27, name:"خیابان اصلی", location:"خیابان اصلی", time:"01:10", difficulty:"متوسط",
      narrative:"سه چراغ راهنما: اولی 3 بار، دومی 5 بار، سومی 7 بار روشن شد. مجموع 15.",
      question:"تعداد کل روشن شدن چراغ‌ها؟", options:["13","14","15","16","17"], correct:2,
    ...
    { id:28, name:"سینما", location:"سینما قدیمی", time:"02:50", difficulty:"متوسط",
      narrative:"صندلی‌ها: 10، 20، 30، 40. هر مرحله 10 تا اضافه می‌شود. بعدی 50.",
      question:"شماره صندلی بعدی؟", options:["45","48","50","55","60"], correct:2,
      clue:"50 - زیر صندلی", evidence:"بلیط سینما", suspect:"فروشنده بلیط", reward:15, focusPenalty:5 },
    { id:29, name:"بانک مرکزی", location:"بانک ملی", time:"03:40", difficulty:"سخت",
      narrative:"گاوصندوق اصلی. رمز: جمع ارقام 1350 (1+3+5+0=9) ضرب در 2 = 18.",
      question:"رمز چند است؟", options:["16","18","20","22","24"], correct:1,
    ...
    { id:30, name:"انتهای خط", location:"مقبره زیرزمینی", time:"06:00", difficulty:"نهایی",
      narrative:"سرداب نهایی. حقیقت کامل در اینجاست. کلمه نهایی چیزی است که شهر را نابود کرد - همان زوال.",
      question:"کلمه نهایی چیست؟", options:["طمع","زوال","سکوت","دروغ","فریب"], correct:1,
...
function useSixthSense() {
    ...
    if (hintBtn) {
        hintBtn.onclick = () => {
            ...
            messageArea.className = 'message-area message-success';
            adSpace.innerHTML = `<div class="ad-placeholder"><span>[ فضای تبلیغات ]</span></div>`;
            saveGame();
        };
    }
